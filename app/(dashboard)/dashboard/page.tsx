...
export default async function DashboardPage() {
  ...
  const steps = [
    ...
    {
      label: "Configurar o fluxo do bot",
      done: hasConfigFlow,
      href: "/dashboard/bots",
    },
    {
  ...
  const quickActions = [
    {
      icon: Package,
      title: "Novo Produto",
      desc: "Cadastre um produto digital para vender.",
      href: "/dashboard/products",
      cta: "Criar produto",
    },
    {
      icon: Bot,
      title: "Novo Bot",
      desc: "Conecte um bot do Telegram à sua loja.",
      href: "/dashboard/bots",
      cta: "Criar bot",
    },
    {
      icon: ShoppingCart,
      title: "Ver Vendas",
      desc: "Acompanhe o histórico de transações.",
